...
const BOT_REPLIES = [
  {
    match: /багаж|докупить|добавить|чемодан|сумка|\bкг\b|билета\s+в\s+санкт-?петербург/i,
    render: () => {
  ...
  {
    match: /возвра|вернуть|возврат\s+билета|комисси|возьм[её]т\s+авиакомпани/i,
    render: () => {
